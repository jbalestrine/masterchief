import os, sys
_PORT = int(os.environ.get('PORT', 9104))
...
import runpy
sys.argv[0] = r'C:\\Users\\Echo\\masterchief\\data\\uploads\\extracted\\php_1\\php\\app.py'
runpy.run_path(r'C:\\Users\\Echo\\masterchief\\data\\uploads\\extracted\\php_1\\php\\app.py', run_name='__main__')
