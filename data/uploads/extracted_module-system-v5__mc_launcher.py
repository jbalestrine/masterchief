...
import runpy
sys.argv[0] = r'C:\\Users\\Echo\\masterchief\\data\\uploads\\extracted\\module-system-v5\\app.py'
runpy.run_path(r'C:\\Users\\Echo\\masterchief\\data\\uploads\\extracted\\module-system-v5\\app.py', run_name='__main__')
