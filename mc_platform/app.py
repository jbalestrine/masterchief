...
blueprints, and services for the DevOps Web GUI mc_platform.
"""
import logging
...
def register_blueprints(app):
    ...
    # Chat API
    try:
        from mc_platform.chat import init_chat_api
...
def setup_event_bus(app):
    ...
    from mc_platform.realtime import register_handlers
