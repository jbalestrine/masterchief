...
$url        = 'https://github.com/jbalestrine/masterchief' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'echomasterchiefx*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
